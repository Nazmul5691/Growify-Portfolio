...
export const NavBar = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 flex items-center justify-between bg-[#440ad6] px-5 md:px-10 lg:px-20 py-2 text-white">
            <div className="scale-100 cursor-pointer rounded-2xl pr-3 py-2 text-xl font-semibold text-white transition-all duration-200 hover:scale-110">
                <h2 className='text-white'>Growify</h2>
            </div>
