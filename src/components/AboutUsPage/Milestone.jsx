...
const Milestone = () => {
        ...
        const observer = new IntersectionObserver((entries) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    setResetTrigger(prev => prev + 1); // Trigger the counter reset
    ...
    return (
        <div className='bg-white'>
            <div>
                <h1 className='text-2xl md:text-3xl lg:text-4xl pt-10 lg:pt-20 lg:w-[40%] mx-auto text-center'>Google only loves you when everyone else love you first</h1>
            </div>
            <div className="milestone my-7">
                {/* use custom css */}
                <div>
